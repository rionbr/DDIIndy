...
CREATE TABLE medication (
	...
	id_catalog BIGINT COMMENT "CATALOGCVCD",
	dt_start DATE NOT NULL COMMENT "ORDERING_DATE",
	dt_end DATE NOT NULL COMMENT "ORDERING_DATE + DURATION",
...
CREATE TABLE coadministration (
	id_medication_drug_i INT,
	id_medication_drug_j INT,
	length INT(4) COMMENT "in days",
	is_ddi BOOLEAN DEFAULT FALSE,
	PRIMARY KEY (id_medication_drug_i, id_medication_drug_j)
) ENGINE=InnoDB;
...
CREATE TABLE drugbank_interaction (
	...
	description TEXT,
	severity VARCHAR(15),
	UNIQUE KEY (id_drug_i, id_drug_j)
) ENGINE=InnoDB;
